...
**<h5>kickass</h5>**:  Scrapper used for extracting set of specific torrents bases on search list and categories.  
**<h5>news</h5>**:  Scrapper used to extract latest breaking news feed.  
