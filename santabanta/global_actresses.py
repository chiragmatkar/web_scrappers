#Web scraper to download Hollywood actress pics from santabanta
...
with open("global_actresses.txt") as f:
    for actress in f:
		if '#' in actress: 
			continue
		else:
			...
			for i in xrange(1,200):
				link="http://media1.santabanta.com/full2/Global%20Celebrities(F)/"+ str(fname)+"%20"+ str(lname) +"/"+str(lowerfname)+"-"+ str(lowerlname)+"-"+str(i)+"a.jpg"				
